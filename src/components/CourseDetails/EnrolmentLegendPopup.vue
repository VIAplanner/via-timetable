<template>
  <Button label="View Legend" size="small" :pt:icon:class="'text-white'" :pt:label:class="'text-white'"
    @click="open = true" />
  <Dialog v-model:visible="open" modal :show-header="true" class="p-0 md:p-4 w-screen lg:w-75vw max-w-50rem"
