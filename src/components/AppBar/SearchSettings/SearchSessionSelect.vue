...
const pendingSessionGroup = ref<SessionGroup | null>(null)
...
function confirmChange() {
  if (pendingSessionGroup.value) {
    ...
    if (pendingSessionGroup.value.subsessions)
      selectedSubsessions.value = pendingSessionGroup.value.subsessions.map(
        (subsession) => subsession.value,
      )
  }
